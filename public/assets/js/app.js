!(function (i) {
    ...
    var e = function () {
        (this.$body = i("body")),
            ...
            (this.$btnFullScreen = i("#btn-fullscreen")),
            (this.$leftMenuButton = i(".button-menu-mobile")),
            (this.$menuItem = i(".has_sub > a"));
    };
    (e.prototype.initSlimscroll = function () {
        i(".slimscrollleft").slimscroll({
            height: "auto",
            position: "right",
            size: "10px",
            color: "#9ea5ab",
        ...
        (e.prototype.initLeftMenuCollapse = function () {
            ...
            this.$leftMenuButton.on("click", function (e) {
                e.preventDefault(),
                    t.$body.toggleClass("fixed-left-void"),
                    t.$wrapper.toggleClass("enlarged");
            });
        }),
        ...
        (e.prototype.initMenu = function () {
            ...
            n.$menuItem.on("click", function () {
                var e = i(this).parent(),
                    t = e.find("> ul");
                return (
                    n.$body.hasClass("sidebar-collapsed") ||
                        (t.is(":visible")
                            ? t.slideUp(300, function () {
                                  e.removeClass("nav-active"),
                                      i(".body-content").css({ height: "" }),
                                      o();
                              })
                            : (i(".has_sub").each(function () {
                                  var e = i(this);
                                  e.hasClass("nav-active") &&
                                      e.find("> ul").slideUp(300, function () {
                                          e.removeClass("nav-active");
                                      });
                              }),
        ...
        (e.prototype.activateMenuItem = function () {
            i("#sidebar-menu a").each(function () {
                this.href == window.location.href &&
                    ...
                    i(this).parent().parent().prev().click());
            });
        }),
